...
<?php
$conn = mysqli_connect("localhost", "root", "", "db_raja");
        ...
        <div class="row">
            ...
            <div class="card info-card bg-success">
              ...
              <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3 ">
                    <h6 class="text-light"><?= $mhs_agama ?></h6>
          ...
          <div class="col-xxl-4 col-md-6">
            <div class="card info-card bg-warning">
              ...
              <div class="card-body">
                <h5 class="card-title text-white">PROVINSI</h5>

                <div class="d-flex align-items-center">
                  <div class="rounded-circle d-flext align-items-center justify-content-center">
                  </div>
                  <div class="ps-3 ">
                    <h6 class="text-light"><?= $mhs_provinsi ?></h6>
